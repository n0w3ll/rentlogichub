<x-app-layout>
    <div class="container px-6 mx-auto grid">
        ...
        <form method="POST" action="{{route('owner.store')}}" class="mt-6">
            @csrf
            ...
            <div class="block md:flex md:space-x-4">
                ...
                <label class="block text-sm mt-4 w-full md:w-1/2 ">
                    ...
                    <input type="text" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="status">
                </label>
            </div>
                ...
                <div class="flex justify-center my-6 text-sm ">
                    <x-dark-button class="w-1/2 md:w-1/3">Add New Owner</x-dark-button>
                </div>
            </div>
        </form>
    </div>
